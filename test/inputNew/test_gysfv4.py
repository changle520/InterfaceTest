...
class Test_MergeOders():
    ...
    def test_GYSFV4_NEW_010(self,update_config_one):
        self.response_xml = moreorders_invaild(testfile, sheetname[1], 'GYSFV4_NEW_010', self.service_code, 7)
        self.test_rlt = get_drugnames(self.response_xml)
        print(self.test_rlt)
        self.error_info = [v for k, v in self.test_rlt if k == 'error_info']
...
if __name__ == '__main__':
    ...
    pytest.main(["-s", "test_gysfv4.py::Test_MergeOders::test_GYSFV4_NEW_010"])
